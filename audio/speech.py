...
# -----------ADJUSTING FOR CHECKERBOARD GAME-----------
#call listener when piece is selected, use audio to decide movement
def listener(piece, row, col):
    ...
    with sr.Microphone() as source:
        while True:
            ...
            if transcript == "move left":
                pass
            if transcript == "move right":
                pass
            if transcript == "move down right":
                pass
            if transcript == "move down left":
                pass
            break
